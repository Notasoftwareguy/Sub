...
# # ROS2 service that sends and receives data from the surface.
# # All communication with the surface should go through this node.
# # Most nodes will just send data to the surface through this node.
# # The surfacepublisher node will publish data received from the surface to a ROS2 topic.
